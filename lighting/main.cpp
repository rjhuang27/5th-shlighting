...
void main(void) {
    ...
    basis[16] = 3.f / 4.f*sqrt(35.f / PI)*x*z*(x2 - z2);
    basis[17] = 3.f / 4.f*sqrt(35.f /(2.f*PI))*y*z*(3*x2 - z2);
    basis[18] = 3.f / 4.f*sqrt(5.f / PI)*x*z*(7*y2 - 1.f);
    basis[19] = 3.f / 4.f*sqrt(5.f / (2.f*PI))*y*z*(7*y2 - 3.f);
    basis[20] = 3.f / 16.f*sqrt(1.f / PI)*(35 * y2*y2 -30*y2+ 3.f);
    basis[21] = 3.f / 4.f*sqrt(5.f / (2.f*PI))*y*x*(7 * y2 - 3.f);
    basis[22] = 3.f / 8.f*sqrt(5.f / PI)*(x2-z2)*(7*y2-1.f);
    basis[23] = 3.f / 4.f*sqrt(35.f / (2.f*PI))*y*x*(x2 -3* z2);
    basis[24] = 3.f / 16.f*sqrt(35.f / PI)*(x2*(x2-3*z2)-z*z*(3*x2-z2));
...
public:
	SHLightingApp(vector< Env* > envs, vector< Object* > objs)
		...
		current_env_(0), current_obj_(0), degree_(4)
	{}
